	...
	<Accordion>
		<AccordionItem open>
			<svelte:fragment slot="summary">
				<h1 class=" h4 font-bold text-center">Filtering Option</h1>
			</svelte:fragment>
				...
				<form action="" method="get">
					<section class="flex flex-row w-full py-6 gap-2">
						<div class="w-full">
							...
							<select name="season" class="select h-full p-4" size="4" value="NONE">
						...
						<div class="w-full">
							...
							<select name="type" class="select h-full p-4" size="4" value="NONE">
						...
						<div class="w-full">
							...
							<select name="status" class="select h-full p-4" size="4" value="NONE">
					...
					<section class="flex flex-row py-6 gap-2">
						<div class="max-h-96 w-full">
							<input name="kw" placeholder="Keywords ..." class="input variant-form-material" />
						</div>
