...
<section
	class="grid px-2 max-h-[520px] lg:max-h-[700px] grid-cols-[repeat(auto-fill,minmax(140px,1fr))] lg:grid-cols-[repeat(auto-fill,minmax(360px,1fr))] gap-2 overflow-y-scroll"
>
