...
export const InfoQuery = (id:string) => `
query Query {
...
export const RecommendationsQuery = (id:string, page:number|any, limit:number|any) => `
query Query {
  Media(id: ${id}, type: ANIME) {
    id
    idMal
...
export const TrendingQuery = (page:number = 1, perPage:number = 20) => `
query {
...
export const PopularQuery = (page:number = 1, perPage: number = 20) =>
  `
  query { 
    Page(page: ${page}, perPage: ${perPage}) { 
      pageInfo { 
