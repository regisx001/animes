...
{#if ready}
	<section class="h-full flex flex-row justify-between pt-12 mx-[2.5%]">
		...
		<section class="w-1/2">
			...
			<div class="flex mt-8 flex-row justify-between gap-4">
				<button class="btn h-14 leading-6 text-black rounded-xl bg-warning-400 font-bold">
					<svg class="w-5 mr-2" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"
						><path
		...
		<section class="flex flex-col items-center gap-10 w-1/4">
			...
			<div class="card p-6 gap-4 variant-glass-surface flex flex-col w-56 rounded-xl font-semibold">
